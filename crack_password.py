...
yesno = raw_input("Do you want the program to pause at each step so you have time to "
              "read the instructions? (type yes or no): ")
...
def report_search_time(tests, seconds):
    if seconds > 0.000001:
        print("The search took "+make_human_readable(seconds)+" seconds for "+make_human_readable(tests)+" tests or "
...
def search_method_3(file_name):
    ...
    while still_searching:
        ...
        if still_searching:
            # print("Checking with capitalize first letter")
            ourguess_pass1 = Cap(ourguess_pass)
            # uncomment the next line to print the current guess
            # print("Guessing: "+ourguess_pass)
            if check_userpass(which_password, ourguess_pass1):
                print("Success! Password "+str(which_password)+" is " + ourguess_pass1)
                still_searching = False   # we can stop now - we found it!
                result = True
            #else:
                #print ("Darn. " + ourguess_pass + " is NOT the password.")
        ...
        # Now let's try it with all the letters capitalized
        if still_searching:
            # print("Checking with all letters captilaized")
            ourguess_pass2 = ourguess_pass.upper()
            # uncomment the next line to print the current guess
            # print("Guessing: "+ourguess_pass)
            if check_userpass(which_password, ourguess_pass2):
                print ("Success! Password "+str(which_password)+" is " + ourguess_pass2)
                still_searching = False   # we can stop now - we found it!
                result = True
            #else:
            #print ("Darn. " + ourguess_pass + " is NOT the password.")
        ...
        # Now let's try it with alternate uppercase/lowercase letters starting with uppercase
        if still_searching:
            # print("Checking with alternate letters capital start upper")
            alternate_case = ''
            for i in range(0, len(ourguess_pass)):
                if i % 2 == 0:
                    alternate_case += ourguess_pass[i].upper()
                else:
                    alternate_case += ourguess_pass[i].lower()

            ourguess_pass3 = alternate_case
            # uncomment the next line to print the current guess
            # print("Guessing: "+ourguess_pass)
            if check_userpass(which_password, ourguess_pass3):
                print("Success! Password "+str(which_password)+" is " + ourguess_pass3)
                still_searching = False   # we can stop now - we found it!
                result = True
            #else:
            #print ("Darn. " + ourguess_pass + " is NOT the password.")
        ...
        # Now let's try it with alternate uppercase/lowercase letters starting with lowercase
        if still_searching:
            # print("Checking with alternate letters capital start lower")
            alternate_case = ''
            for i in range(0, len(ourguess_pass)):
                if i % 2 == 0:
                    alternate_case += ourguess_pass[i].lower()
            ...
            ourguess_pass4 = alternate_case
            # uncomment the next line to print the current guess
            # print("Guessing: "+ourguess_pass)
            if check_userpass(which_password, ourguess_pass4):
                print("Success! Password "+str(which_password)+" is " + ourguess_pass4)
                still_searching = False   # we can stop now - we found it!
                result = True
            #else:
            #print ("Darn. " + ourguess_pass + " is NOT the password.")
        ...
        # Now let's try it with the word spelled backwards
        if still_searching:
            # print("Checking with word spelled backwards")
            ourguess_pass5 = ourguess_pass[::-1]
            # uncomment the next line to print the current guess
            # print("Guessing: "+ourguess_pass)
            if check_userpass(which_password, ourguess_pass5):
                print("Success! Password "+str(which_password)+" is " + ourguess_pass5)
                still_searching = False   # we can stop now - we found it!
                result = True
            #else:
            #print ("Darn. " + ourguess_pass + " is NOT the password.")
...
def search_method_4(file_name):
    ...
    while still_searching:
        ...
        if still_searching:
            ...
            tests = tests + 1
            totalguesses = totalguesses + 1
        # Now let's try it with both words capitalized
        if still_searching:
...
# *** METHOD 5 ***
# Search method 5 is similar to 4 in that it uses the dictionary, but it tries three
# words separated by a punctuation character.
def search_method_5(file_name):
    global totalguesses
    result = False
    ...
    number_of_puncs = len(punctuation)
    print()
    print("Using method 5 with "+str(number_of_puncs)+" punctuation characters and "+str(number_of_words)+" words...")

    while still_searching:
        # if "X" == punctuation[punc_count] and "X" != punctuation[punc2_count]:
        #     ourguess_pass = words[word1count] + words[word2count] \
        #                     + punctuation[punc2_count] + words[word3count]
        # elif "X" != punctuation[punc_count] and "X" == punctuation[punc2_count]:
        #     ourguess_pass = words[word1count] + punctuation[punc_count] + words[word2count] \
        #                     + words[word3count]
        # elif "X" == punctuation[punc_count] and "X" == punctuation[punc2_count]:
        #     # If we're at the end of the string and found the 'X', leave it out
        ...
        #     tests = tests + 1
        #     totalguesses = totalguesses + 1
        # # Now let's try it with the first letter of the third word capitalized
        # if still_searching:
        #     ourguess_pass = words[word1count] + punctuation[punc_count] + words[word2count] \
        #                     + punctuation[punc2_count] + Cap(words[word3count])
        #     # uncomment the next line to print the current guess
        #     print("Guessing: "+ourguess_pass)
        #     if check_userpass(which_password, ourguess_pass):
        #         print("Success! Password "+str(which_password)+" is " + ourguess_pass)
        ...
        # # Now let's try it with first and second words capitalized
        # if still_searching:
        #     ourguess_pass = Cap(words[word1count]) + punctuation[punc_count] + Cap(words[word2count]) \
        #                     + punctuation[punc2_count] + words[word3count]
        #     # uncomment the next line to print the current guess
        ...
        # # Now let's try it with second and third words capitalized
        # if still_searching:
        #     ourguess_pass = words[word1count] + punctuation[punc_count] + Cap(words[word2count]) \
        #                     + punctuation[punc2_count] + Cap(words[word3count])
        #     # uncomment the next line to print the current guess
        ...
        # # Now let's try it with first and third words capitalized
        # if still_searching:
        #     ourguess_pass = Cap(words[word1count]) + punctuation[punc_count] + words[word2count] \
        #                     + punctuation[punc2_count] + Cap(words[word3count])
        #     # uncomment the next line to print the current guess
        ...
        # Now let's try it with the three words capitalized
        if still_searching:
            ourguess_pass = Cap(words[word1count]) + punctuation[punc_count] + Cap(words[word2count]) \
                            + punctuation[punc2_count] + Cap(words[word3count])
            # uncomment the next line to print the current guess
        ...
        if word1count >= number_of_words:
            ...
            if punc_count >= number_of_puncs:
                ...
                if word2count >= number_of_words:
                    word2count = 0
                    punc2_count = punc2_count + 1
                    if punc2_count >= number_of_puncs:
                        punc2_count = 0
...
def search_combine_1_3(file_name):
    global totalguesses
    result = False
    ...
    number_of_words = len(words)
    print()
    print("Using method 1 and 3 combined with a list of "+str(number_of_words)+" words...")
    ...
    while still_searching:
        ...
        if still_searching:
            ...
            a = 0
            while still_searching and a < (10**5):
                ourguess = leading_zeroes(a, 5)
                # uncomment the next line to print each guess, this can help with debugging
                # print(ourguess)
                tests = tests + 1
                totalguesses = totalguesses + 1
                new_guess = ourguess_pass4 + ourguess
                print(new_guess)
                if(check_userpass(which_password, new_guess)):
                    print("Success! Password "+str(which_password)+" is " + new_guess)
                    still_searching = False   # we can stop now - we found it!
                    result = True
                #else:
                #print ("Darn. " + ourguess + " is NOT the password.")
...
def main(argv=None):
    ...
    # password6 = "9b3af42d61cde121f40b96097fb77d3e"  # method 3 not working after modification

    # personal password method 3 not working after modification
    password6 = "fd293c4f00f20493fd5b5bcbb240e610"

    # method 5 worked for this 123456+password+12345678
    # password6 = MD5me('password1456')
    ...
    # if not foundit:
    #     foundit = search_combine_1_3("passwords.txt")
...
#    if not foundit:
 #       foundit = search_method_3("passwords.txt")
    ...
    # Still looking? Let's combine the common passwords 3 at a time
    if not foundit:
        print("Method 4 did not work!")
        if show_instructions:
            input("Press enter to continue.")
        foundit = search_method_5("passwords.txt")

    # Still looking? See if it's a single digit
    # if not foundit:
    #     print("Method 5 did not work!")
    #     if show_instructions:
    #         input("Press enter to continue.")
    ...
    if foundit:
        if 6 == which_password:
            print("Wow! Be sure to confirm your find at http://www.sciencebuddies.org/science-fair-projects/"
                  "project_ideas/CompSci_p046/PasswordCrack.shtml")
        elif 0 == which_password:  # The Science Buddies website can't confirm passwords you added yourself
            print("Your algorithm correctly guessed the password you entered. Try some others or see if you can "
                  "make it guess faster.")
        else:
            print("You can confirm your find at http://www.sciencebuddies.org/science-fair-projects/project_ideas"
                  "/CompSci_p046/PasswordCrack.shtml")
